...
namespace Finalsmile6868\Repository\Eloquent;

use Illuminate\Support\Collection;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Container\Container as App;
use Finalsmile6868\Repository\Contracts\RepositoryInterface;
use Finalsmile6868\Repository\Exceptions\RepositoryException;
use Finalsmile6868\Repository\Contracts\CriteriaInterface;
use Finalsmile6868\Repository\Criteria\Criteria;

/**
 * Class Repository
 * @package Finalsmile6868\Repository\Eloquent
 */
abstract class Repository implements RepositoryInterface, CriteriaInterface
{
     ...
     * @throws \Finalsmile6868\Repository\Exceptions\RepositoryException
     */
    ...
    {
        $this->applyCriteria();
        $result = $this->model->where($attribute, '=', $value)->get($columns);
        $this->resetCriteria();
        return $result;
    }
